...
const ManagerDashboard = ({ stats, openDetail, openAllAlerts }: { stats: any, openDetail: any, openAllAlerts: any }) => {
  ...
  return (
  <>
    <DashboardHeader title="Dashboard Operasional" subtitle="Real-time System Overview" />
...
const DirectorDashboard = ({ stats }: { stats: any }) => (
  <>
    <DashboardHeader title="Executive Dashboard" subtitle="PT United Multilift Perkasa" />
